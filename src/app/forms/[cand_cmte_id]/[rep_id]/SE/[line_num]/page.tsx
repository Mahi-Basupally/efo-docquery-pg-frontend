...
export default function ScheduleEPage() {
  ...
  const [scheduleData, setScheduleData] = useState<ScheduleEResponse | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await scheduleEApi.getScheduleEData(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_E_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">ITEMIZED INDEPENDENT EXPENDITURES - Schedule E (Line #{lineNum})</h3>
                  </div>
