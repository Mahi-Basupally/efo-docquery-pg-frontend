...
export default function ScheduleCPage() {
  ...
  const [scheduleData, setScheduleData] = useState<ScheduleCResponse | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await scheduleCApi.getScheduleCData(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule C - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_C_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">LOANS - Schedule C (Line #{lineNum})</h3>
                  </div>
