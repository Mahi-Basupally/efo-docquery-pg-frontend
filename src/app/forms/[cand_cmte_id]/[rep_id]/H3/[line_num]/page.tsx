...
export default function H3Page() {
  ...
  const [scheduleData, setScheduleData] = useState<H3Response | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await h3Api.getH3Data(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const formatValue = (value: any, description: string): string => {
    ...
    // Format currency columns - H3 has "transfer" and "amount" fields
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule H3 - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_H3_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">Schedule H3 (Line #{lineNum})</h3>
                  </div>
                            ...
                            <th
                              ...
                              style={{
                                textAlign: col.description.toLowerCase().includes('amount') ||
                                          col.description.toLowerCase().includes('transferred') ||
                                          col.description.toLowerCase().includes('transfer') ||
