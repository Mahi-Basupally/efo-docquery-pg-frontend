...
export default function ScheduleBPage() {
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await scheduleBApi.getScheduleBData(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule B - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_B_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">ITEMIZED DISBURSEMENTS - Schedule B (Line #{lineNum})</h3>
                  </div>
