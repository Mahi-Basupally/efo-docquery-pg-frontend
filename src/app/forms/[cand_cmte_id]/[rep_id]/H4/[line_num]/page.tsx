...
export default function H4Page() {
  ...
  const [scheduleData, setScheduleData] = useState<H4Response | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await h4Api.getH4Data(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const formatValue = (value: any, description: string): string => {
    ...
    // Format currency columns - H4 has "share" and "amount" fields
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule H4 - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_H4_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">Schedule H4 (Line #{lineNum})</h3>
                  </div>
