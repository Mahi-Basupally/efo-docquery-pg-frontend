              ...
              <div className="row content__section">
                <div className="entity__figure row">
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">INDEPENDENT EXPENDITURES - Form 57</h3>
                  </div>

                  <F57Renderer reportId={repId} perPage={50} />
                </div>
              </div>
            </div>
          </section>
