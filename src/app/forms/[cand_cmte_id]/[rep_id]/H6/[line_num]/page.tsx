...
export default function H6Page() {
  ...
  const [scheduleData, setScheduleData] = useState<H6Response | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await h6Api.getH6Data(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const formatValue = (value: any, description: string): string => {
    ...
    if (description.toLowerCase().includes('amount') ||
        description.toLowerCase().includes('share') ||
        description.toLowerCase().includes('ytd') ||
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule H6 - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_H6_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">Schedule H6 (Line #{lineNum})</h3>
                  </div>
                            ...
                            <th
                              ...
                              style={{
                                textAlign: col.description.toLowerCase().includes('amount') ||
                                          col.description.toLowerCase().includes('share') ||
                                          col.description.toLowerCase().includes('ytd') ||
