...
export default function ScheduleFPage() {
  ...
  const [scheduleData, setScheduleData] = useState<ScheduleFResponse | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await scheduleFApi.getScheduleFData(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule F - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_F_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">COORDINATED EXPENDITURES - Schedule F (Line #{lineNum})</h3>
                  </div>
