...
import F56Renderer from '@/components/schedules/f56/f56_rendering';
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">INDEPENDENT EXPENDITURES - Form 56</h3>
                  </div>

                  <F56Renderer reportId={repId} perPage={50} />
                </div>
              </div>
            </div>
          </section>
