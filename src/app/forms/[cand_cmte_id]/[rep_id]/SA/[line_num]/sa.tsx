...
export default function ScheduleAPage() {
  ...
  const [scheduleData, setScheduleData] = useState<ScheduleAResponse | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await scheduleAApi.getScheduleAData(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule A - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_A_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">ITEMIZED RECEIPTS - Schedule A (Line #{lineNum})</h3>
                    {lineNum === '3L' && (
                      <h3 className="tags__title">Reportable Bundled Contributions Forwarded By or Credited to Lobbyists/Registrants And Lobbyist/Registrant PACs</h3>
                    )}
                  </div>
                  {/* Data Table */}
