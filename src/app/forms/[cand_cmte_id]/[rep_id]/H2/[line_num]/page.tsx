...
import { h2Api, H2Response } from '@/lib/api/h2';
...
export default function H2Page() {
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await h2Api.getH2Data(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const formatValue = (value: any, description: string): string => {
    ...
    // Format percentage columns - H2 has federalPercent and nonFederalPercent
    // Values are stored as basis points (e.g., 9900 = 99.00%)
    if (description.toLowerCase().includes('percent') || description.toLowerCase().includes('%')) {
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule H2 - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_H2_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">Schedule H2 (Line #{lineNum})</h3>
                  </div>
                            ...
                            <th
                              ...
                              style={{
                                textAlign: col.description.toLowerCase().includes('amount') ||
                                          col.description.toLowerCase().includes('percent') ||
