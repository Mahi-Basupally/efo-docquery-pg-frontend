...
export default function H5Page() {
  ...
  const [scheduleData, setScheduleData] = useState<H5Response | null>(null);
  ...
  useEffect(() => {
    const fetchScheduleData = async () => {
      try {
        ...
        const response = await h5Api.getH5Data(repId, lineNum, {
          page: currentPage,
          perPage: perPage,
        });
  ...
  const formatValue = (value: any, description: string): string => {
    ...
    // Format currency columns - H5 has "transferred" and "amount" fields
  ...
  const breadcrumbItems = [
    ...
    { label: `Schedule H5 - Line ${lineNum}`, href: '' },
  ];
              ...
              <div className="row content__section">
                <div className="entity__figure row">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                      <button
                        ...
                        onClick={() => {
                          ...
                          a.href = url;
                          a.download = `schedule_H5_${lineNum}_page_${currentPage}.json`;
                          a.click();
                  ...
                  <div className="heading--section heading--with-action">
                    <h3 className="entity__title">Schedule H5 (Line #{lineNum})</h3>
                  </div>
