...
export const F4_LINE_DEFINITIONS: Record<string, F4LineDefinition> = {
  'f4-line-6a': { lineNumber: '6 (a)', label: 'Cash On Hand January 1, {REPLACE_YEAR}' },
  'f4-line-6b': { lineNumber: '6 (b)', label: 'Cash On Hand at Beginning Of Reporting Period' },
  'f4-line-6c': { lineNumber: '6 (c)', label: 'Total Receipts', note: 'From Line 20', linkId: 'f4-line-20' },
  'f4-line-6d': { lineNumber: '6 (d)', label: 'Subtotal', calculation: 'Add Lines 6(b) and 6(c) for Column A and Lines 6(a) and 6(c) for Column B' },
  ...
  'f4-line-12a': { lineNumber: '12 (a)', label: 'Expenditures Subject To Limitation', calculation: 'Subtract Line 12 from Line 11' },
  'f4-line-12b': { lineNumber: '12 (b)', label: 'Expenditures From Prior Years Subject To Limitation' },
  'f4-line-12c': { lineNumber: '12 (c)', label: 'Total Expenditures Subject To Limitation', calculation: 'Add Lines 12(a) and 12(b)' },
  ...
  'f4-line-14a': { lineNumber: '14 (a)', label: 'Itemized', note: 'Use Schedule A' },
  'f4-line-14b': { lineNumber: '14 (b)', label: 'Unitemized' },
  'f4-line-14c': { lineNumber: '14 (c)', label: 'Subtotal of Contributions to Defray Convention Expenses', calculation: 'Add Lines 14(a) and 14(b}' },
  ...
  'f4-line-16a': { lineNumber: '16 (a)', label: 'Loans Received' },
  'f4-line-16b': { lineNumber: '16 (b)', label: 'Loan Repayments Received' },
  'f4-line-16c': { lineNumber: '16 (c)', label: 'Subtotal of Loans and Loan Repayments Received ', calculation: 'Add Lines 17a and 17b' },
  'f4-line-17': { lineNumber: '17', label: 'Refunds Rebates, Returns of Deposits Relating to Convention Expenditures:', valueType: 'mergetd' },
  'f4-line-17a': { lineNumber: '17 (a)', label: 'Itemized', note: 'Use Schedule A' },
  'f4-line-17b': { lineNumber: '17 (b)', label: 'Unitemized' },
  'f4-line-17c': { lineNumber: '17 (c)', label: 'Subtotal of Refunds, Rebates, Returns of Deposits Relating to Convention Expenditures:' },
  'f4-line-18': { lineNumber: '18', label: 'Other Refunds, Rebates, Returns of Deposits:', valueType: 'mergetd' },
  'f4-line-18a': { lineNumber: '18 (a)', label: 'Itemized Other Refunds, Rebates, Returns of Deposits' },
  'f4-line-18b': { lineNumber: '18 (b)', label: 'Unitemized Other Refunds, Rebates, Returns of Deposits' },
  'f4-line-18c': { lineNumber: '18 (c)', label: 'Subtotal of Other Refunds, Rebates, Returns of Deposits', calculation: 'Add Lines 18(a) and 18(b)' },
  'f4-line-19': { lineNumber: '19', label: 'Other Income:', valueType: 'mergetd' },
  'f4-line-19a': { lineNumber: '19 (a)', label: 'Itemized', note: 'Use Schedule A' },
  'f4-line-19b': { lineNumber: '19 (b)', label: 'Unitemized' },
  'f4-line-19c': { lineNumber: '19 (c)', label: 'Subtotal of Other Incom', calculation: 'Add Lines 19(a) and 19(b)' },
  ...
  'f4-line-21a': { lineNumber: '21 (a)', label: 'Itemized', note: 'Use Schedule A' },
  'f4-line-21b': { lineNumber: '21 (b)', label: 'Unitemized' },
  'f4-line-21c': { lineNumber: '21 (c)', label: 'Subtotal of Convention Expenditure', calculation: ' (Add Lines 21 (a) and 21 (b)' },
  ...
  'f4-line-23a': { lineNumber: '23 (a)', label: 'Loans Made' },
  'f4-line-23b': { lineNumber: '23 (b)', label: 'Loan Repayments Made' },
  'f4-line-23c': { lineNumber: '23 (c)', label: '(c) Subtotal' },
  'f4-line-24': { lineNumber: '24', label: '24. Other Disbursements:', valueType: 'mergetd' },
  'f4-line-24a': { lineNumber: '24 (a)', label: '(a) Itemized' },
  'f4-line-24b': { lineNumber: '24 (b)', label: '(b) Unitemized' },
  'f4-line-24c': { lineNumber: '24 (c)', label: 'Subtotal of Loans and Loan Repayments Made', calculation: 'Add Lines 23(a)and 23(b)' },
